  ...
  lastname = ""
   ...
   local text = "_⭕️First name :_ *"..firstname.."*\n_⭕️Last name :_ *"..lastname.."*\n_⭕️Username :_ "..username.."\n_🆔ID :_ *"..data.id_.."*\n\n"
		    if data.id_ == tonumber(Solid) then
		       text = text..'_🌐Rank :_ *Executive Admin*\n\n'
			   elseif is_sudo1(data.id_) then
	           text = text..'_🌐Rank :_ *Full Access Admin*\n\n'
		     elseif is_admin1(data.id_) then
		       text = text..'_🌐Rank :_ *Bot Admin*\n\n'
		     elseif is_owner1(arg.chat_id, data.id_) then
		       text = text..'_🌐Rank :_ *Group Owner*\n\n'
		     elseif is_mod1(arg.chat_id, data.id_) then
		       text = text..'_🌐Rank :_ *Group Moderator*\n\n'
		 else
		       text = text..'_🌐Rank :_ *Group Member*\n\n'
			end
         local user_info = {} 
